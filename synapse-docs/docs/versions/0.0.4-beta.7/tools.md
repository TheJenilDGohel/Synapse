...
<div className="docPanel docPanel--compact">
  <p>
    Beta.7 keeps the broad retrieval and memory tool surface from beta.6 while shifting the local
    model runtime and package/install behavior underneath the same top-level CLI flow.
  </p>
</div>
