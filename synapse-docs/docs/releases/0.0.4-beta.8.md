---
description: Archived release notes for synapse-mcp 0.0.4-beta.8 covering MCP startup fixes, safer sqlite-vec status handling, and release hardening.
---

# 0.0.4-beta.8

Archived release notes for `synapse-mcp@0.0.4-beta.8`.
...
<div className="docGrid docGrid--3">
  ...
  <div className="docPanel">
    ...
    <p>Use the current release page when you want the packaged stable fixes and latest documented contract.</p>
  </div>
  <div className="docPanel">
