---
description: Archived release notes for synapse-mcp 0.0.4-beta.7 covering sqlite-vec install hardening, Hugging Face runtime migration, and beta package cleanup.
---

# 0.0.4-beta.7

Archived release notes for `synapse-mcp@0.0.4-beta.7`.
...
<div className="docGrid docGrid--3">
  ...
  <div className="docPanel">
    ...
    <p>Use the current release page when you want the latest stable contract and post-fix runtime behavior.</p>
  </div>
  <div className="docPanel">
...
- refreshed docs and bundled skill guidance around the canonical `synapse` setup flow
