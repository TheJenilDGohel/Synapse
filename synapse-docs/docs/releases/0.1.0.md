---
description: Release notes for synapse-mcp 0.1.0 covering full TypeScript migration, CLI refresh with spinners, performance optimizations, and dependency updates.
---

# 0.1.0

Release notes for `synapse-mcp@0.1.0`.
