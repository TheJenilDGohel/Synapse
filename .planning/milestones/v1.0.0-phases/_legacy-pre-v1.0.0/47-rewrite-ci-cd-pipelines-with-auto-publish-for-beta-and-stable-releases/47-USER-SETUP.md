...
- [ ] **Configure trusted publisher for synapse package**
  - Location: `https://www.npmjs.com/package/synapse/access -> Trusted Publishers -> Add -> org=wmt-mobile, repo=synapse, workflow=release.yml`
