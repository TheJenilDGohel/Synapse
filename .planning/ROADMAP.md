...
- [ ] **Phase 1: Engine Isolation** - Create the `src/engine/` module and move all SQLite database queries, graph traversals, and semantic indexing into this pure layer (satisfies CORE-01, CORE-02).
...
|-------|-----------|----------------|--------|-----------|
| 1. Engine Isolation | v1.0.0 | 0/0 | Not started | - |
