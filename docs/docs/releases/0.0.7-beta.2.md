---
description: Beta release notes for synapse 0.0.7-beta.2 covering temporal knowledge graph, multi-hop traversal, nest/branch hierarchy, agent-scoped memory, semantic dedup, conversation ingestion, hooks system, CLI-first architecture, and 17 new MCP tools.
---

# 0.0.7-beta.2

Beta release notes for `synapse@0.0.7-beta.2`.
...
- Legacy deprecation: old `synapse-*` binaries now show deprecation warnings and redirect to canonical commands.
