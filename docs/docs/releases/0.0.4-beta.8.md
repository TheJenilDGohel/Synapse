---
description: Archived release notes for synapse 0.0.4-beta.8 covering MCP startup fixes, safer sqlite-vec status handling, and release hardening.
---

# 0.0.4-beta.8

Archived release notes for `synapse@0.0.4-beta.8`.
