#!/usr/bin/env node
// Synapse Post-Tool Hook for Claude Code
//
...
// 3. Calls `synapse capture-outcome` CLI to save into memory
//
// The hook gracefully degrades: if synapse CLI isn't on PATH or
