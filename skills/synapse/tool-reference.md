# Synapse Tool Reference (v2026.5.0)

Synapse uses high-density **Power Controllers** to minimize context window overhead and ensure compatibility with strict AI clients like Gemini. Always use the `action` parameter to specify the operation.
