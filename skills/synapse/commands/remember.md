---
name: synapse:remember
description: Save a decision, fact, or learning to Synapse memory
argument-hint: "<what to remember>"
allowed-tools:
  - Read
  - Bash
  - mcp__synapse__synapse_memory_store
  - mcp__synapse__synapse_memory_suggest_relations
  - mcp__synapse__synapse_memory_add_relation
---

<objective>
Store a durable memory entry in Synapse so it can be recalled in future sessions.
</objective>
