...
export function normalizeTaskContextResult(result: Record<string, unknown> | null | undefined, input: Record<string, unknown> = {}): NormalizedTaskContextResult {
  ...
  return {
    ...
    memory: {
      ...
      total_entries: Number.isFinite(memory.total_entries as number) ? (memory.total_entries as number) : 0,
