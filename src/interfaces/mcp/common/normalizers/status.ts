...
export function normalizeEmbedStatus(status: Record<string, unknown> | null | undefined): NormalizedEmbedStatus {
  ...
  const available = (embedding.available as boolean | undefined) ?? false;
  ...
  return {
    ...
    enabled,
    available,
    dimensions: (embedding.dimensions as number | undefined) ?? null,
    error: (embedding.error as string | undefined) || null,
    sqlite_vec_loaded: (status?.sqlite_vec_loaded as boolean | undefined) ?? ((status?.sqlite_vec_extension as Record<string, unknown>)?.loaded as boolean | undefined) ?? null,
    sqlite_vec_extension: (status?.sqlite_vec_extension as Record<string, unknown>) || null,
    sqlite_vec_table_ready: (status?.sqlite_vec_table_ready as boolean | undefined) ?? null,
    embedding
  };
}
...
export function normalizeMemoryStatus(status: Record<string, unknown> | null | undefined): NormalizedMemoryStatus {
  ...
  return {
    ...
    requested_backend: (status?.requested_backend as string | undefined) ?? (backend.requested as string | undefined) ?? null,
    ...
    backend: {
      requested: (backend.requested as string | undefined) ?? (status?.requested_backend as string | undefined) ?? null,
      selected: (backend.selected as string | undefined) ?? null,
      available: Boolean(backend.available),
      reason: (backend.reason as string | undefined) || null
    },
    store: {
      ...
      error: (store.error as string | undefined) || null
    }
  };
}
...
export function normalizeTaskContextResult(result: Record<string, unknown> | null | undefined, input: Record<string, unknown> | null | undefined = {}): NormalizedTaskContextResult {
  ...
  return {
    ...
    recall: {
      ...
      skipped_reason: (recall.skipped_reason as string | undefined) || '',
