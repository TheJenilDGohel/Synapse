...
export const LANGUAGE_LOADERS: Record<string, LanguageLoader> = {
  javascript: async () => { const mod = await import('tree-sitter-javascript' as string); return mod.default || mod; },
  python: async () => { const mod = await import('tree-sitter-python' as string); return mod.default || mod; },
  go: async () => { const mod = await import('tree-sitter-go' as string); return mod.default || mod; },
  bash: async () => { const mod = await import('tree-sitter-bash' as string); return mod.default || mod; },
  lua: async () => { const mod = await import('tree-sitter-lua' as string); return mod.default || mod; },
  dart: async () => { const mod = await import('tree-sitter-dart' as string); return mod.default || mod; },
  typescript: async () => { const mod = await import('tree-sitter-typescript' as string); return (mod.default || mod).typescript; },
  tsx: async () => { const mod = await import('tree-sitter-typescript' as string); return (mod.default || mod).tsx; },
  rust: async () => { const mod = await import('tree-sitter-rust' as string); return mod.default || mod; }
};
